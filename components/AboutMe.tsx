...
const AboutMe: React.FC = () => {
  return (
    <div className="bg-[#1E1E1E] rounded-3xl shadow-xl overflow-hidden text-white p-6 md:p-10">
      ...
      <p className="mb-4">
        I'm in Software Engineering because I have a strong desire to improve the world through technology. 
        Since I was a child, I loved everything about technology, building a competition ready robot in 
        grade 6 was what set things in motion. Today, I think what sets you apart is my well-roundedness. 
        I'm not just diverse in my technical skill sets, but I am constantly engaged with the business side. 
